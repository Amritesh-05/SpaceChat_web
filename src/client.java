...
public class client {
    ...
    private static final Color C_BG      = new Color(0x161b22);  // chat area
    private static final Color C_HDR1    = new Color(0x0d1117);  // header dark end
    private static final Color C_HDR2    = new Color(0x1a237e);  // header indigo end
    private static final Color C_SENT1   = new Color(0x4f46e5);  // sent bubble gradient start
    private static final Color C_SENT2   = new Color(0x7c3aed);  // sent bubble gradient end
    private static final Color C_RECV    = new Color(0x21262d);  // received bubble bg
    private static final Color C_NOTIF   = new Color(0x484f58);  // notification text
    private static final Color C_ACCENT  = new Color(0x58a6ff);  // accent blue
    private static final Color C_GREEN   = new Color(0x3fb950);  // online dot
    private static final Color C_RED     = new Color(0xf85149);  // danger/delete
    private static final Color C_SIDEBAR = new Color(0x0d1117);  // sidebar bg
    private static final Color C_TEXT1   = new Color(0xc9d1d9);  // primary text
    private static final Color C_TEXT2   = new Color(0x8b949e);  // secondary text
    private static final Color C_DIVIDER = new Color(0x30363d);  // borders/dividers
    ...
    private static class BubblePanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (sent) {
                ...
                // Left accent line per-sender color
                g2.setColor(new Color(0x58a6ff));
                g2.fillRoundRect(0, 0, 3, h - 3, 3, 3);
            }
            g2.dispose();
        }
    }
    ...
    private void setupUI() {
        ...
        frame.getContentPane().setBackground(new Color(0x161b22));
        ...
        split.setBackground(new Color(0x30363d));
    ...
    private JPanel buildSidebar() {
        ...
        sidebarPanel.setBorder(new MatteBorder(0, 0, 0, 1, new Color(0x30363d)));
        sidebarPanel.setPreferredSize(new Dimension(190, 0));

        JLabel title = new JLabel("Online Users");
        title.setFont(new Font("SansSerif", Font.BOLD, 12));
        title.setForeground(new Color(0x484f58));
        ...
        hint.setForeground(new Color(0x484f58));
    ...
    private JPanel buildChatArea() {
        ...
        chatArea.setBackground(new Color(0x161b22));

        chatPanel = new JPanel();
        chatPanel.setLayout(new BoxLayout(chatPanel, BoxLayout.Y_AXIS));
        chatPanel.setBackground(new Color(0x161b22));
        chatPanel.setBorder(new EmptyBorder(12, 8, 12, 8));

        chatScroll = new JScrollPane(chatPanel);
        chatScroll.setBorder(null);
        chatScroll.getVerticalScrollBar().setUnitIncrement(16);
        chatScroll.getViewport().setBackground(new Color(0x161b22));
    ...
    private JPanel buildInputBar() {
        ...
        bar.setBackground(new Color(0x0d1117));
        bar.setBorder(new CompoundBorder(
                new MatteBorder(1, 0, 0, 0, new Color(0x30363d)),
        ...
        messageField.setBorder(new CompoundBorder(
                new LineBorder(new Color(0x30363d), 1, true),
                new EmptyBorder(9, 14, 9, 14)
        ));
        messageField.setBackground(new Color(0x21262d));
        messageField.setForeground(new Color(0xc9d1d9));
        messageField.setCaretColor(new Color(0x58a6ff));
    ...
    private void addHistoryDivider() {
        ...
        JSeparator left  = new JSeparator(); left.setForeground(new Color(0x30363d));
        JSeparator right = new JSeparator(); right.setForeground(new Color(0x30363d));
        JLabel lbl = new JLabel("  Chat History  ");
        lbl.setFont(new Font("SansSerif", Font.PLAIN, 10));
        lbl.setForeground(new Color(0x484f58));
    ...
    private void addNotification(String message) {
        ...
        lbl.setForeground(new Color(0x8b949e));
        lbl.setBackground(new Color(0x21262d));
        lbl.setOpaque(true);
    ...
    private MessageData addMessageBubble(String msgId, String sender, String text, long ts, boolean isMine) {
        ...
        timeLabel.setForeground(isMine ? new Color(0xc4b5fd) : new Color(0x484f58));
        meta.add(timeLabel);
    ...
    private JTextArea buildTextArea(String text, boolean isMine) {
        ...
        ta.setForeground(isMine ? Color.WHITE : new Color(0xc9d1d9));
    ...
    private JLabel makeReactionChip(String emoji, int count, String msgId, boolean iMine) {
        ...
        JLabel chip = new JLabel(emoji + " " + count) {
            ...
            protected void paintComponent(Graphics g) {
                Graphics2D g2 = (Graphics2D) g.create();
                g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                g2.setColor(iMine ? new Color(99, 91, 255, 120) : new Color(255, 255, 255, 12));
        ...
        chip.setForeground(iMine ? new Color(0xc7d2fe) : new Color(0x8b949e));
    ...
    private void showEmojiInsertPicker(Component parent) {
        ...
        grid.setBackground(new Color(0x21262d));
    ...
    private void stylePopup(JPopupMenu menu) {
        menu.setBackground(new Color(0x21262d));
        menu.setBorder(new LineBorder(new Color(0x30363d), 1, true));
    }
    ...
    private class UserCellRenderer implements ListCellRenderer<UserEntry> {
        ...
        public Component getListCellRendererComponent(JList<? extends UserEntry> list,
            ...
            JPanel row = new JPanel(new BorderLayout(8, 0));
            row.setBackground(selected ? new Color(0x21262d) : C_SIDEBAR);
            ...
            nameLbl.setForeground(new Color(0xc9d1d9));
            info.add(nameLbl);

            if (value.admin) {
                JLabel badge = new JLabel("admin");
                badge.setFont(new Font("SansSerif", Font.BOLD, 9));
                badge.setForeground(new Color(0x79c0ff));
                badge.setBackground(new Color(0x1f3a5f));
